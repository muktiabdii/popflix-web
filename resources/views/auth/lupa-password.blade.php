...
<head>
    ...
    <title>Reset Password - PopFlix</title>
...
<body class="bg-gunmetal-black text-light-gray flex items-center justify-center min-h-screen">
    <div class="bg-dark-gray rounded-lg shadow-lg p-8 max-w-md w-full">
        <h2 class="text-3xl font-bold text-crimson-red mb-6 text-center">Reset Password</h2>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-4">
                <label for="password" class="block text-gray-secondary mb-2">Password Baru</label>
            ...
            <div class="mb-6">
                <label for="password_confirmation" class="block text-gray-secondary mb-2">Konfirmasi Password</label>
                <input type="password" name="password_confirmation" id="password_confirmation" class="w-full px-4 py-2 bg-gray-secondary text-light-gray rounded focus:outline-none focus:ring-2 focus:ring-soft-blue" required>
            </div>
            <button type="submit" class="w-full px-4 py-2 bg-crimson-red text-light-gray rounded hover:bg-soft-blue">Reset Password</button>
        </form>

        <p class="text-gray-secondary text-center mt-4">
            Ingat password? <a href="{{ route('login') }}" class="text-crimson-red hover:text-soft-blue">Login</a>
        </p>
    </div>
</body>
</html>